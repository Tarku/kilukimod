...
public class MCreatorReinforcedStoneBricksWall extends Elementskilukimod.ModElement {
	@ObjectHolder("kilukimod:reinforcedstonebrickswall")
	public static final Block block = null;

	public MCreatorReinforcedStoneBricksWall(Elementskilukimod instance) {
		super(instance, 96);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(4f, 8000f).lightValue(0));
			setRegistryName("reinforcedstonebrickswall");
		}
