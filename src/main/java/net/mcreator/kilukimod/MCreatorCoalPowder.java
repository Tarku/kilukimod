...
public class MCreatorCoalPowder extends Elementskilukimod.ModElement {
	@ObjectHolder("kilukimod:coalpowder")
	public static final Item block = null;

	public MCreatorCoalPowder(Elementskilukimod instance) {
		super(instance, 13);
	}
